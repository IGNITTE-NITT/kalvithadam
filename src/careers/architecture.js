...
const architecture = () => {
  ...
  return (
    <div className="container">
      ...
      <h3>Overview</h3>
      <ul>
        <li>JEE MAINS Paper - 2</li>
        <li>AAT</li>
        <li>NATA</li>
        <li>Central Government Institutes</li>
        <li>Private Institutes</li>
      </ul>

      <hr />

      <h3>JEE MAINS PAPER 2</h3>

      <br />

      <h4>INTRODUCTION</h4>
      <p>JEE Mains Paper-2 is the entrance exam for admission into courses such as B.Arch and B. Planning in various NITs (National Institute of Technology) and GFTIs (Government-funded Technical Institutes), IIITs (Indian Institute of Information Technology), CFTIs (Centrally Funded Technical Institute).</p>
